...
Expected: compile failure — `hivewarden::roles` doesn't exist yet.
...
Expected: compile failure — `/orgs/{org_id}/roles` etc. don't exist as routes, `hivewarden::org_admin` doesn't exist.
