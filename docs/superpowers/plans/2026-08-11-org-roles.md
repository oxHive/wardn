...
Expected: compile failure — `hivemind_gateway::roles` doesn't exist yet.
...
Expected: compile failure — `/orgs/{org_id}/roles` etc. don't exist as routes, `hivemind_gateway::org_admin` doesn't exist.
